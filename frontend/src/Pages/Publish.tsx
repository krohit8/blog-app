        ...
        <div className="w-full mb-4">
            <div className="flex items-center justify-between border rounded-lg">
                <div className="my-2 bg-white rounded-b-lg w-full">
                    ...
                    <textarea onChange={onChange} value={value} id="editor" rows={6} className="focus:outline-none block w-full px-3 py-2 text-sm sm:text-base text-gray-800 bg-white border-0 rounded-lg resize-none" placeholder="Write an article..." required />
                </div>
            </div>
        </div>
    </div>
